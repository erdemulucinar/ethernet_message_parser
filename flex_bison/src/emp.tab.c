...
#define ID 267
#define NUMBER 268
#define BIT_FIELD 269




/* Copy the first part of user declarations.  */
#line 1 "flex_bison/defs/emp.y"
...
{
  "$end", "error", "$undefined", "MESSAGE", "IS", "REPORT", "RAM",
  "RECORD", "OUTPUT", "DEF", "COMBINE", "EQ", "ID", "NUMBER", "BIT_FIELD",
  "$accept", "msg_def_list", "msg_def", "msg_line_list", "msg_line",
  "field_vector_indices", 0
};
#endif
...
{
       2,    -1,     3,   -14,    -2,   -14,   -14,     4,    -4,     6,
       7,     5,     1,    -4,   -14,    -4,     8,     9,   -14,    10,
      12,   -14,    -4,   -14,   -14,   -14,    13,   -14,    14,   -14
};
...
{
      21,    10,     7,     5,    11,     1,     1,     8,    12,    21,
      19,     4,    20,    16,    17,    15,     9,    18,     6,     0,
      23,    24,     0,    28,    25,    27,    22,     0,    29
};

static const yytype_int8 yycheck[] =
{
      13,     5,     4,     0,     8,     3,     3,     9,    12,    22,
       9,    12,    11,     6,     7,     9,    12,    12,     2,    -1,
      12,    12,    -1,    10,    14,    13,    15,    -1,    14
};
...
{
       0,     3,    16,    17,    12,     0,    17,     4,     9,    12,
       5,     8,    12,    18,    19,     9,     6,     7,    12,     9,
      11,    19,    18,    12,    12,    14,    20,    13,    10,    14
};
...
do								\
  if (yychar == YYEMPTY && yylen == 1)				\
    ...
    {								\
      yyerror (msgList, YY_("syntax error: cannot back up")); \
      YYERROR;							\
    }								\
while (YYID (0))
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, Rule, msgList); \
} while (YYID (0))
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (msgList, YY_("syntax error"));
#else
      {
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (msgList, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
